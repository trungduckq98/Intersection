package com.deathmarch.intersection.chatbot;
...
public class ChatBotActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerViewDDD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       toolbar = findViewById(R.id.toolbar999);

        recyclerViewDDD = findViewById(R.id.recycler_view999);
        ...
        recyclerViewDDD.setLayoutManager(layoutManager);
        recyclerViewDDD.setItemAnimator(new DefaultItemAnimator());

        recyclerViewDDD.setAdapter(mAdapter);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (CheckNetwork.check(ChatBotActivity.this)) {
                    sendMessage();
                }
            }
        });
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                if (mAdapter.getItemCount() > 1) {
                                    recyclerViewDDD.getLayoutManager().smoothScrollToPosition(recyclerViewDDD, null, mAdapter.getItemCount() - 1);
